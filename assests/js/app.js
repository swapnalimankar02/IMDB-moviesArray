...
var result = "";
countries.forEach(function (flags) {
  result += `
              ...
              <img src="${flags.flag}" alt="Flag">
                <figCaption>
                  ...
                  <div class="countryData">
                          <ul>
                              <li><strong>Capital:</strong>${flags.capital}</li>
                              <li><strong>Language:</strong>${flags.languages}</li>
                              <li><strong>Population:</strong>${flags.population}</li>
                          </ul>
                  </div>                                    
              </figCaption>                                
          </figure>
